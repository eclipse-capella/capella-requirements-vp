 ...
 * @generated
 */
public class DateValueAttribute_Definition_AttributeDefinition extends BQTestCase {
  ...
  public List<String> getRequiredTestModels() {
	...
	public String getBQFullQualifiedName() {
		return "org.polarsys.capella.vp.requirements.business.queries.DateValueAttribute_Definition_AttributeDefinition"; //$NON-NLS-1$
	}
