 ...
 * @generated
 */
public class Requirement_CapellaOutgoingRelation_CapellaElement extends BQTestCase {
	...
	public String getBQFullQualifiedName() {
		return "org.polarsys.capella.vp.requirements.business.queries.Requirement_CapellaOutgoingRelation_CapellaElement"; //$NON-NLS-1$
	}
