 ...
 * @generated
 */
public class StringValueAttribute_Definition_AttributeDefinition extends BQTestCase {
	...
	public String getBQFullQualifiedName() {
		return "org.polarsys.capella.vp.requirements.business.queries.StringValueAttribute_Definition_AttributeDefinition"; //$NON-NLS-1$
	}
