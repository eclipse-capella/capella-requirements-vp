 ...
 * @generated
 */
public class IntegerValueAttribute_Definition_AttributeDefinition extends BQTestCase {
	...
	public String getBQFullQualifiedName() {
		return "org.polarsys.capella.vp.requirements.business.queries.IntegerValueAttribute_Definition_AttributeDefinition"; //$NON-NLS-1$
	}
