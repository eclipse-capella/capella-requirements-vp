 ...
 * @generated
 */
public class EnumerationValueAttribute_Definition_AttributeDefinition extends BQTestCase {
	...
	public String getBQFullQualifiedName() {
		return "org.polarsys.capella.vp.requirements.business.queries.EnumerationValueAttribute_Definition_AttributeDefinition"; //$NON-NLS-1$
	}
