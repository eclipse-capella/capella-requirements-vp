 ...
 * @generated
 */
public class EnumerationValueAttribute_Values_EnumValue extends BQTestCase {
	...
	public String getBQFullQualifiedName() {
		return "org.polarsys.capella.vp.requirements.business.queries.EnumerationValueAttribute_Values_EnumValue"; //$NON-NLS-1$
	}
