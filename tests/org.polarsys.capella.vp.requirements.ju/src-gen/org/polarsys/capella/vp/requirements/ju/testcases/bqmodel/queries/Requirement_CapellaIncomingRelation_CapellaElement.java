 ...
 * @generated
 */
public class Requirement_CapellaIncomingRelation_CapellaElement extends BQTestCase {
	...
	public String getBQFullQualifiedName() {
		return "org.polarsys.capella.vp.requirements.business.queries.Requirement_CapellaIncomingRelation_CapellaElement"; //$NON-NLS-1$
	}
