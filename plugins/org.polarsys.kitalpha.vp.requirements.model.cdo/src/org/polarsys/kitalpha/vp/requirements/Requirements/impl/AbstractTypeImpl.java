...
public abstract class AbstractTypeImpl extends ReqIFElementImpl implements AbstractType {
	...
	public EList<AttributeDefinition> getOwnedAttributes() {
		...
		return (EList<AttributeDefinition>) eDynamicGet(RequirementsPackage.ABSTRACT_TYPE__OWNED_ATTRIBUTES,
				RequirementsPackage.Literals.ABSTRACT_TYPE__OWNED_ATTRIBUTES, true, true);
	}
