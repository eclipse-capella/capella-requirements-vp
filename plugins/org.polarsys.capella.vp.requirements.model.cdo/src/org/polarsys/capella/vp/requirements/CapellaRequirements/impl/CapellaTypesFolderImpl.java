...
import org.polarsys.kitalpha.vp.requirements.Requirements.impl.TypesFolderImpl;
...
public class CapellaTypesFolderImpl extends TypesFolderImpl implements CapellaTypesFolder {
	 ...
	 * @generated
	 */
	protected CapellaTypesFolderImpl() {
	...
	public EList<ElementExtension> getOwnedExtensions() {
		...
		return (EList<ElementExtension>) eDynamicGet(CapellaRequirementsPackage.CAPELLA_TYPES_FOLDER__OWNED_EXTENSIONS,
