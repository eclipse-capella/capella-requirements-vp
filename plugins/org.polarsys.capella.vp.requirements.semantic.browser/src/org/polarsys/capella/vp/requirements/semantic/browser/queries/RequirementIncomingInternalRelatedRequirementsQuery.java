 ...
 * @author Joao Barata
 */
public class RequirementIncomingInternalRelatedRequirementsQuery implements IQuery {
	...
	public List<Object> compute(Object object_p) {
		...
		for (EObject eObject : EObjectExt.getReferencers(object, RequirementsPackage.Literals.INTERNAL_RELATION__TARGET)) {
