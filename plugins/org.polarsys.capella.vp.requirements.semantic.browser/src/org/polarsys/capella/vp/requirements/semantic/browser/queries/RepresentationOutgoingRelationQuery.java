...
public class RepresentationOutgoingRelationQuery extends AbstractViewpointQuery {
    ...
    for (Couple<Requirement, RelationType> requirement : RelationAnnotationHelper.getAllocations(descriptor, RelationAnnotationHelper.OutgoingRelationAnnotation).values()) {
      if (requirement != null)
