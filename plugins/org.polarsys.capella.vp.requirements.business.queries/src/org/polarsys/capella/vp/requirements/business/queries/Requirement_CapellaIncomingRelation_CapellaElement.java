 ...
 * @author Joao Barata
 */
public class Requirement_CapellaIncomingRelation_CapellaElement extends Requirement_CapellaRelation_CapellaElement {
  ...
  @Override
    ...
    for (BlockArchitecture currentAndPreviousBlock : BlockArchitectureExt.getAllAllocatedArchitectures(currentBlock)) {
      availableElements.addAll(getCapellaElements(currentAndPreviousBlock));
    }
