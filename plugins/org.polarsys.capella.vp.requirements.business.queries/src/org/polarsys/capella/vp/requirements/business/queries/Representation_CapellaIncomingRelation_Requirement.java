...
public class Representation_CapellaIncomingRelation_Requirement extends Representation_CapellaRelation_Requirement {
  ...
  @Override
    ...
    if (element instanceof DRepresentationDescriptor) {
      ...
      for (Couple<Requirement, RelationType> allocation : RelationAnnotationHelper.getAllocations((DRepresentationDescriptor) element, RelationAnnotationHelper.IncomingRelationAnnotation).values()) {
