 ...
 * @author Joao Barata
 */
public class TypesFolderSection extends AbstractSection {
  ...
  protected BasicReqIFElementGroup reqIFElementGroup;
	...
	public boolean select(Object eObject) {
		...
		if (KitalphaRequirementsUIPropertiesPlugin.isViewpointActive(eObjectToTest) && eObjectToTest instanceof TypesFolder) {
			return true;
		}
		return false;
	}
	...
	*/
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (newEObject instanceof TypesFolder) {
			loadData(newEObject);
		}
	}
