...
public class IntegerAttributeSection extends AttributeSection {
  ...
  protected IntegerValueGroup valueField;
  ...
  public void createControls(Composite parent, TabbedPropertySheetPage aTabbedPropertySheetPage) {
    ...
    valueField = new IntegerValueGroup(getReferencesGroup(),
  ...
  public void loadData(EObject capellaElement) {
    ...
    valueField.loadData(capellaElement, RequirementsPackage.eINSTANCE.getIntegerValueAttribute_Value());
