 ...
 * @author Joao Barata
 */
public class DataTypeDefinitionSection extends AbstractSection {
  ...
  protected BasicReqIFElementGroup reqIFElementGroup;
	...
	public boolean select(Object eObject) {
		...
		if (KitalphaRequirementsUIPropertiesPlugin.isViewpointActive(eObjectToTest) && eObjectToTest instanceof DataTypeDefinition) {
			return true;
		}
		return false;
	}
	...
	*/
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (newEObject instanceof DataTypeDefinition) {
			loadData(newEObject);
		}
	}
