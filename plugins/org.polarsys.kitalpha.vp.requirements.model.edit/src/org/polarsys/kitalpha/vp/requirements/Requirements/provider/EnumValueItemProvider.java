...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.vp.requirements.Requirements.EnumValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumValueItemProvider extends ReqIFElementItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? "[" + getString("_UI_EnumValue_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
