...
public class RequirementsPreferencesConstants {
  ...
  public static final String REQUIREMENT_DEFAULT_LABEL_EXPRESSION = "aql:(self.ownedAttributes->select( a | a.definition.ReqIFLongName == 'IE PUID').value + OrderedSet{self.ReqIFText, self.ReqIFLongName, self.ReqIFChapterName}->select(s | s != 'null' and s.length > 0)->first())->sep(' ')";
